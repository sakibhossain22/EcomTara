      ...
      <div className="px-6 lg:px-20">
        <div className="bg-[#6346FE] rounded-[2rem] p-8 md:p-12 flex flex-col lg:flex-row items-center justify-between gap-8 relative overflow-hidden shadow-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 relative z-10 w-full lg:w-auto">
            <Link href='#demo'>
              <button className="bg-white w-full cursor-pointer text-[#6346FE] px-10 py-4 rounded-2xl font-bold text-lg hover:shadow-[0_10px_20px_rgba(255,255,255,0.2)] transition-all active:scale-95 whitespace-nowrap">
                ডেমো দেখুন
              </button>
            </Link>
            <Link href='#pricing'>
              <button className="border-2 w-full cursor-pointer border-white/30 text-white px-10 py-4 rounded-2xl font-bold text-lg hover:bg-white/10 transition-all active:scale-95 whitespace-nowrap">
                যোগাযোগ করুন
              </button>
            </Link>
          </div>
